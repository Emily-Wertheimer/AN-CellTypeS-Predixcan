...
## define tissue
tissue_predix <- 'AN_BasoAmyg'
cell_type_predix <- '_Excitatory_Neurons'
suffix <- '.carina.cell.type' 


## read in spredix results and tissues
spredix_software_path <-'/gpfs/gibbs/pi/huckins/software/MetaXcan/software/SPrediXcan.py' # ~/AN-CellTypeS-Predixcan/sPrediXcan_AN/software'
...
all_features <- NULL
tissue_here <- 'Baso_Amyg_Excitatory_Neurons'
path_feature_here <- sprintf('/home/ekw28/AN-CellTypeS-Predixcan/freeze3_cellTypes_repo/carina_cellType_annotations.txt')
